...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        String sql = "SELECT dept, COUNT(dept) teacherCount FROM teacher GROUP BY teacher.dept;";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT courseCode, courseDesc, COUNT(student_id) numStudents FROM course c INNER JOIN course_student cs ON c.cid = cs.course_id GROUP BY courseCode, courseDesc;";
